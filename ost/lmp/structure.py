...
"""
    ...
    def _write_data(self, of, orthogonality=False, padding=[0, 0, 0]):
        ...
        for i, (a, r) in enumerate(zip(self.atoms, self.coordinates), 1):
            ...
            of.write(
                "%6d %6d %6d %13.8f %11.7f %11.7f %11.7f #%s:%s\n"
    ...
    def _write_molecule(self, of, parent=None):
        ...
        nbonds, nangles, ndiheds = self._write_dat_connects(
    ...
    def write_lammps(
        self, fin="lmp.in", fdat="lmp.dat", orthogonality=False, padding=[0, 0, 0]
    ):
